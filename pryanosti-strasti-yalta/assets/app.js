/* === Мини-отель «Пряности и Страсти» · bespoke 2026 interactions === */
(function(){
  "use strict";
  ...
  if(items.length){
    ...
    lb.innerHTML='<span class="lb-close" aria-label="Закрыть">&times;</span><span class="lb-nav lb-prev" aria-label="Назад">&#8249;</span><img alt="Фото мини-отеля Пряности и Страсти"><span class="lb-nav lb-next" aria-label="Вперёд">&#8250;</span>';
